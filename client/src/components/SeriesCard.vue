...
<template>
  <div class="card group hover:shadow-card transition-all duration-300 h-full flex flex-col">
    <router-link :to="`/series/${series.slug}`" class="flex flex-col h-full">
      ...
      <div class="flex-grow space-y-3">
        <h3 class="text-xl font-bold group-hover:text-primary-700 transition-colors">
          {{ series.title }}
        </h3>
