...
<template>
  <div>
    ...
    <HeroBanner
      ...
      ctaLink="/teaching/understanding-gods-grace"
    ...
    <section class="py-16 bg-white">
      <div class="container mx-auto px-4">
        <div class="text-center mb-10">
          ...
          <p class="text-neutral-600 max-w-2xl mx-auto">Fresh biblical insights to encourage and strengthen your faith</p>
        </div>
        ...
        <div v-else-if="!latestTeaching" class="text-center py-12 text-neutral-500">
    ...
    <section class="py-16 bg-neutral-50">
      <div class="container mx-auto px-4">
        <div class="text-center mb-10">
          ...
          <p class="text-neutral-600 max-w-2xl mx-auto">Explore collections of teachings around key biblical themes</p>
        </div>
        ...
        <div v-else-if="featuredSeries.length === 0" class="text-center py-12 text-neutral-500">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div class="order-2 md:order-1">
              ...
              <p class="text-neutral-700 mb-4">
                Pastor Michael Johnson has been teaching the Word of God for over 20 years, helping believers deepen their understanding of Scripture and apply biblical principles to everyday life.
              </p>
              <p class="text-neutral-700 mb-6">
                With a passion for clear, practical Bible teaching, Pastor Michael focuses on helping Christians grow in their faith and find hope in God's promises.
              </p>
    ...
    <section class="py-16 bg-primary-800 text-white">
      <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto text-center">
          ...
          <p class="mb-8">
            Receive weekly teachings, event notifications, and spiritual encouragement straight to your inbox.
          </p>
